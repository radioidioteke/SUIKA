...
public class BannerAdView extends RelativeLayout {
	...
	private WebView createWebView(final Context context) {
		...
		webView.setLayoutParams(new LayoutParams(10, 10));
	...
	private void buildBannerView() {
		...
		final float masterWidth = mContext.getResources().getDisplayMetrics().widthPixels;

		// this.setLayoutParams(new
		// RelativeLayout.LayoutParams((int)(600*scale+0.5f),
		// (int)(50*scale+0.5f)));
		this.setLayoutParams(new RelativeLayout.LayoutParams((int) (masterWidth), (int) (60 * scale + 0.5f)));
		final FrameLayout.LayoutParams webViewParams = new FrameLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.FILL_PARENT);
		this.viewFlipper.addView(this.firstWebView, webViewParams);
		this.viewFlipper.addView(this.secondWebView, webViewParams);

		final RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.FILL_PARENT);
		...
		if (this.animation) {
			...
			this.fadeOutAnimation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, -1.0f);
